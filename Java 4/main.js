...
const camera = new THREE.PerspectiveCamera(
    75, //kendi, field of view,
    window.innerWidth / window.innerHeight,//aspect ratio, gjersia e dritares / lartesia e dritares
    0.1,
    1000
)
camera.position.set(0,2,3); //e heqim pak pas kameren
camera.lookAt(0,0,0);
